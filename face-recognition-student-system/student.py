...
class Student:
    def __init__(self,root):
        ...
        # ===============Images==================================
        img10 = Image.open("college_images/img/std.jpg")
        img10 = img10.resize((1300,170), Image.ANTIALIAS)
        ...
        # ==================== Project title ==================================================
        title=Label(self.root,text="PHOTO SAMPLING PORTAL",font=("times new roman",30,"bold"),bg="white",fg="crimson")
        title.place(x=0,y=60,width=1250,height=35)


        img_logo = Image.open("college_images/img/bti.png")
        ...
        img30 = Image.open("college_images/img/cse.jfif")
        ...
        img20 = Image.open("college_images/img/bti.png")
        ...
        lbl_id=Label(std_personalData_label_frame,font=("arial",12,"bold"),text="Vaccinated:",bg="white")
        lbl_id.grid(row=0,column=0,sticky=W,padx=2,pady=7)

        txt_id=ttk.Entry(std_personalData_label_frame,textvariable=self.var_vaccinated,width=22,font=("arial",11,"bold"))
        ...
        lbl_div=Label(std_personalData_label_frame,font=("arial",12,"bold"),text="Section:",bg="white")
        lbl_div.grid(row=1,column=0,sticky=W,padx=2,pady=7)

        com_txt_div=ttk.Combobox(std_personalData_label_frame,textvariable=self.var_section,state="readonly",
        ...
        lbl_roll=Label(std_personalData_label_frame,font=("arial",12,"bold"),text="USN :",bg="white")
        lbl_roll.grid(row=1,column=2,sticky=W,padx=2,pady=7)

        txt_roll=ttk.Entry(std_personalData_label_frame,textvariable=self.var_usn,width=22,font=("arial",11,"bold"))
        ...
        img30 = Image.open("college_images/img/std.jpg")
        ...
        search_combo['values']=("Select Option","phone","usn","department")
        ...
        self.student_table=ttk.Treeview(Table_frame,column=("ref_id","dep","course","year","sem","vaccinated","name","section","usn","gender","dob","email","phone","address","teacher","photo",
                                            )
        ...
        self.student_table.heading("vaccinated",text="Vaccinated")
        ...
        self.student_table.column("vaccinated",width=100)
    ...
    def add_data(self):
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_usn.get()=="" or self.usertype.get()==""):
            messagebox.showerror("Error","All Fields Are Required",parent=self.root)
        else:
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="csalam123",database="studentdb")
                my_cursor=conn.cursor()
                my_cursor.execute('insert into new_student(id,department,course,year,semester,vaccinated,student_name,section,usn,gender,dob,email,phone,address,teacher_name,photo_sample ) values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',(
                                                                                                            id,
                                                                                                            self.var_dep.get(),
                                                                                                            self.var_course.get(),
                                                                                                            self.var_year.get(),
                                                                                                            self.var_semester.get(),
                                                                                                            self.var_vaccinated.get(),
        ...
        if (self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_usn.get()=="" or self.usertype.get()==""):
            ...
            try:
                ...
                if update>0:
                    ...
                    my_cursor.execute("update new_student set department=%s,course=%s,year=%s,semester=%s,vaccinated=%s,student_name=%s,section=%s,usn=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher_name=%s,photo_sample=%s where id=%s",(
