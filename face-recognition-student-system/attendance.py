...
class Attendace:
    def __init__(self,root):
        ...
        # =============================== Variables===========================================
        self.var_atten_vaccinated=StringVar()
        ...
        img10 = Image.open("college_images/img/bti-bg.jpg")
        img10 = img10.resize((1600,200), Image.ANTIALIAS)
        self.photoImg10 = ImageTk.PhotoImage(img10)
        bg_lbl=Label(self.root,image=self.photoImg10)
        bg_lbl.place(x=0,y=0,width=1600,height=200)
        ...
        img1 = Image.open("college_images/img/bti-bg.jpg")
        ...
        title=Label(self.root,text="STUDENT ATTENDANCE SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="crimson")
        ...
        img30 = Image.open("college_images/img/bti.png")
        ...
        empLabel=Label(updateframe,text="Vaccinated:",bg="white",font="comicsansns 11 bold")
        empLabel.grid(row=0,column=0,padx=4,pady=8)

        nameLabel=Label(updateframe,text="USN:",bg="white",font="comicsansns 11 bold")
        ...
        # ============================= Entry ====================================================
        self.atten_id=ttk.Entry(updateframe,textvariable=self.var_atten_vaccinated,width=22,font="comicsansns 11 bold")
        self.atten_id.grid(row=0,column=1,pady=8)
        self.atten_id.focus()

        atten_name=ttk.Entry(updateframe,textvariable=self.var_atten_usn,width=22,font="comicsansns 11 bold")
    ...
    def get_cuesor(self,event=""):
        ...
        row=content["values"]
        self.var_atten_vaccinated.set(row[0])
        self.var_atten_usn.set(row[1])
    ...
    # export upadte
    def action(self):
        id=self.var_atten_vaccinated.get()
        roll=self.var_atten_usn.get()
