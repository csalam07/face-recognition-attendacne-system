...
class FaceRecognitionSystem:
    def __init__(self,root):
        ...
        # ===============Images==================================
        img10 = Image.open("college_images/imgs/bti-bg.jpg")
        ...
        # ====================Background image==============================================
        img1 = Image.open("college_images/imgs/main.jpg")
        ...
        # ==================== Project title ==================================================
        title=Label(bg_lbl,text="FACE RECOGNITION STUDENT SYSTEM",font=("times new roman",30,"bold"),bg="white",fg="darkblue")
        title.place(x=0,y=(-2),width=1540,height=45)

        # ==================== Project buttom(description) ==================================================
        downtitle=Label(self.root,text="A year spent in artificial intelligence is enough to make one believe in Allah",font=("times new roman",20,"bold"),bd=2,relief=RAISED,bg="white",fg="red")
        ...
        # ==================Student Department Button ===========================================
        
        img2 = Image.open("college_images/img/student.png")
        ...
        # ==================Train Button ===========================================
        img3 = Image.open("college_images/img/train-data.jpg")
        ...
        photo_label.place(x=500,y=380,width=222,height=40)

        # ==================Face Detector Button ===========================================
        img = Image.open("college_images/img/face_detector1.jpg")
        ...
        # ==================Sample Image Button ===========================================
        img4 = Image.open("college_images/img/teaser.png")
        ...
        img5 = Image.open("college_images/img/attendance.png")
        ...
        # ==================Chat Bot Button ===========================================
        # img6 = Image.open("college_images/imgs/chatbot.jpg")
        ...
        # img7 = Image.open("college_images/imgs/team-bg.jpg")
        ...
        # ==================Exit Image Button ===========================================
        img8 = Image.open("college_images/imgs/close.jpg")
        ...
        b8.place(x=800,y=460,width=220,height=220)
    ...
    # ================== Exit function =======================================================================
    def iExit(self):
        self.iExit=messagebox.askyesno("Face Recognition Student System","Confirm you want to exit",parent=self.root)
        if self.iExit >0:
            self.root.destroy()
        else:
            return
